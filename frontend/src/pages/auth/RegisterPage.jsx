...
//   return (
//     <div className="min-h-screen linear-to-br from-blue-50 to-blue-100 flex items-center justify-center py-10">
...
export default function RegisterPage() {
    ...
    Object.keys(data).forEach(key => {
      ...
      if (Array.isArray(data[key])) {
        ...
        Object.keys(data[key]).forEach(subKey => {
          formattedErrors[subKey] = data[key][subKey][0]
        })
  ...
  return (
    ...
    <div className="min-h-screen linear_to_br from-blue-50 to-blue-100 flex items-center justify-center py-10">
